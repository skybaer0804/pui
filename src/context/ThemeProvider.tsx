...
/**
 * 디자인 토큰 오버라이드 타입
 * CSS 변수명을 키로, 값을 값으로 가지는 객체
 * 예: { '--color-interactive-primary': '#ff0000', '--primitive-space-4': '16px' }
 */
export type DesignTokenOverrides = Record<string, string | number>;
...
interface ThemeProviderProps {
  ...
  /**
   * 디자인 토큰 오버라이드
   * CSS 변수명을 키로 하는 객체를 전달하여 디자인 토큰을 커스터마이징할 수 있습니다.
   * 
   * @example
   * ```tsx
   * <ThemeProvider
