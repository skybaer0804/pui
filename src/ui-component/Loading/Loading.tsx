                        ...
                        {[...Array(7)].map((_, i) => {
                            ...
                            return (
                                <path
                                    ...
                                    d={`M100,100 Q${50 - offset},${100 - curveY} ${endX},${100 + endY} Q${50 - offset},${100 + curveY} 100,100`}
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        {[...Array(7)].map((_, i) => {
                            ...
                            return (
                                <path
                                    ...
                                    d={`M100,100 Q${150 + offset},${100 - curveY} ${endX},${100 - endY} Q${150 + offset},${100 - curveY} 100,100`}
                                    fill="none"
                                    stroke="currentColor"
                                    strokeWidth={2.5 - i * 0.25}
                                    opacity={1 - i * 0.12}
